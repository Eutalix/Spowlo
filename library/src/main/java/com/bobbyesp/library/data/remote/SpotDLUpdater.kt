...
internal object SpotDLUpdater {
    ...
    internal fun update(
        ...
        try {
            ...
            // --- REMOVED CALL: The initSpotDL function was deleted during refactoring. ---
            // This fallback logic might need to be re-thought, but for now,
            // we remove the call to allow compilation.
            // TODO: Re-implement a fallback mechanism for updater failures.
